...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.Id = field.NewUint32(tableName, "id")
	_product.Name = field.NewString(tableName, "name")
	_product.Amount = field.NewInt(tableName, "amount")
	_product.Description = field.NewString(tableName, "description")
	_product.Picture = field.NewString(tableName, "picture")
	_product.Price = field.NewFloat32(tableName, "price")
	_product.Categories = field.NewField(tableName, "categories")
...
func (p *product) updateTableName(table string) *product {
	...
	p.Amount = field.NewInt(table, "amount")
	p.Description = field.NewString(table, "description")
	p.Picture = field.NewString(table, "picture")
	p.Price = field.NewFloat32(table, "price")
