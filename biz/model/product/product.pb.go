...
type ListProductsReq struct {
	...
	PageSize     int64  `protobuf:"varint,2,opt,name=pageSize,proto3" form:"pageSize" json:"pageSize,omitempty" query:"pageSize"`
	CategoryName string `protobuf:"bytes,3,opt,name=categoryName,proto3" form:"categoryName" json:"categoryName,omitempty" query:"categoryName"`
}
...
type Product struct {
	...
	Categories  []string `protobuf:"bytes,6,rep,name=categories,proto3" form:"categories" json:"categories,omitempty" query:"categories"`
}
...
type ListProductsResp struct {
	...
	Products []*Product `protobuf:"bytes,1,rep,name=products,proto3" form:"products" json:"products,omitempty" query:"products"`
}
...
type GetProductResp struct {
	...
	Product *Product `protobuf:"bytes,1,opt,name=product,proto3" form:"product" json:"product,omitempty" query:"product"`
}
...
type SearchProductsReq struct {
	...
	Query string `protobuf:"bytes,1,opt,name=query,proto3" form:"query" json:"query,omitempty" query:"query"`
}
...
type SearchProductsResp struct {
	...
	Results []*Product `protobuf:"bytes,1,rep,name=results,proto3" form:"results" json:"results,omitempty" query:"results"`
}
...
var file_product_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x34,
	0x5a, 0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x55, 0x31, 0x74,
	0x72, 0x61, 0x56, 0x65, 0x6e, 0x6f, 0x2f, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x2d, 0x73, 0x68,
	0x6f, 0x70, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x70, 0x72, 0x6f,
