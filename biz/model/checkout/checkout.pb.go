...
import (
	payment "github.com/U1traVeno/tiktok-shop/biz/model/payment"
...
type Address struct {
	...
	ZipCode       string `protobuf:"bytes,5,opt,name=zip_code,json=zipCode,proto3" form:"zip_code" json:"zip_code,omitempty" query:"zip_code"`
}
...
type CheckoutReq struct {
	...
	Firstname  string                  `protobuf:"bytes,2,opt,name=firstname,proto3" form:"firstname" json:"firstname,omitempty" query:"firstname"`
	Lastname   string                  `protobuf:"bytes,3,opt,name=lastname,proto3" form:"lastname" json:"lastname,omitempty" query:"lastname"`
	...
	CreditCard *payment.CreditCardInfo `protobuf:"bytes,6,opt,name=credit_card,json=creditCard,proto3" form:"credit_card" json:"credit_card,omitempty" query:"credit_card"`
}
...
var file_checkout_proto_rawDesc = []byte{
	...
	0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x55, 0x31, 0x74, 0x72,
	0x61, 0x56, 0x65, 0x6e, 0x6f, 0x2f, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x2d, 0x73, 0x68, 0x6f,
	0x70, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x63, 0x68, 0x65, 0x63,
