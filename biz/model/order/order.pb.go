...
type Address struct {
	...
	StreetAddress string `protobuf:"bytes,1,opt,name=street_address,json=streetAddress,proto3" form:"street_address" json:"street_address,omitempty" query:"street_address"`
	City          string `protobuf:"bytes,2,opt,name=city,proto3" form:"city" json:"city,omitempty" query:"city"`
	State         string `protobuf:"bytes,3,opt,name=state,proto3" form:"state" json:"state,omitempty" query:"state"`
	Country       string `protobuf:"bytes,4,opt,name=country,proto3" form:"country" json:"country,omitempty" query:"country"`
	ZipCode       int32  `protobuf:"varint,5,opt,name=zip_code,json=zipCode,proto3" form:"zip_code" json:"zip_code,omitempty" query:"zip_code"`
}
...
type PlaceOrderReq struct {
	...
	UserCurrency string       `protobuf:"bytes,2,opt,name=user_currency,json=userCurrency,proto3" form:"user_currency" json:"user_currency,omitempty" query:"user_currency"`
	Address      *Address     `protobuf:"bytes,3,opt,name=address,proto3" form:"address" json:"address,omitempty" query:"address"`
	Email        string       `protobuf:"bytes,4,opt,name=email,proto3" form:"email" json:"email,omitempty" query:"email"`
	OrderItems   []*OrderItem `protobuf:"bytes,5,rep,name=order_items,json=orderItems,proto3" form:"order_items" json:"order_items,omitempty" query:"order_items"`
}
...
type OrderItem struct {
	...
	Item *cart.CartItem `protobuf:"bytes,1,opt,name=item,proto3" form:"item" json:"item,omitempty" query:"item"`
	Cost float32        `protobuf:"fixed32,2,opt,name=cost,proto3" form:"cost" json:"cost,omitempty" query:"cost"`
}
...
type PlaceOrderResp struct {
	...
	Order *OrderResult `protobuf:"bytes,1,opt,name=order,proto3" form:"order" json:"order,omitempty" query:"order"`
}
...
type Order struct {
	...
	OrderItems   []*OrderItem `protobuf:"bytes,1,rep,name=order_items,json=orderItems,proto3" form:"order_items" json:"order_items,omitempty" query:"order_items"`
	...
	UserId       uint32       `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" form:"user_id" json:"user_id,omitempty" query:"user_id"`
	UserCurrency string       `protobuf:"bytes,4,opt,name=user_currency,json=userCurrency,proto3" form:"user_currency" json:"user_currency,omitempty" query:"user_currency"`
	Address      *Address     `protobuf:"bytes,5,opt,name=address,proto3" form:"address" json:"address,omitempty" query:"address"`
	Email        string       `protobuf:"bytes,6,opt,name=email,proto3" form:"email" json:"email,omitempty" query:"email"`
	CreatedAt    int32        `protobuf:"varint,7,opt,name=created_at,json=createdAt,proto3" form:"created_at" json:"created_at,omitempty" query:"created_at"`
}
...
type ListOrderResp struct {
	...
	Orders []*Order `protobuf:"bytes,1,rep,name=orders,proto3" form:"orders" json:"orders,omitempty" query:"orders"`
}
...
var file_order_proto_rawDesc = []byte{
	...
	0x42, 0x32, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x55,
	0x31, 0x74, 0x72, 0x61, 0x56, 0x65, 0x6e, 0x6f, 0x2f, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x2d,
	0x73, 0x68, 0x6f, 0x70, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x6f,
