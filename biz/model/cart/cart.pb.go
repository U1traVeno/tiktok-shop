...
type CartItem struct {
	...
	ProductId uint64 `protobuf:"varint,1,opt,name=product_id,json=productId,proto3" form:"product_id" json:"product_id" query:"product_id"`
	Quantity  uint64 `protobuf:"varint,2,opt,name=quantity,proto3" form:"quantity" json:"quantity" query:"quantity"`
}
...
type AddItemReq struct {
	...
	UserId uint64    `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" form:"user_id" json:"user_id" query:"user_id"`
...
type GetCartReq struct {
	...
	UserId uint64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id" query:"user_id"`
}
...
type GetCartResp struct {
	...
	StatusCode int32  `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" form:"status_code" json:"status_code" query:"status_code"`
	StatusMsg  string `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	Cart       *Cart  `protobuf:"bytes,3,opt,name=cart,proto3" form:"cart" json:"cart,omitempty" query:"cart"`
}
...
var file_cart_proto_rawDesc = []byte{
	...
	,
	...
	0x69, 0x64, 0x22, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x04, 0x69,
	...
	0x65, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x12, 0x37,
	...
	,
	...
	0x67, 0x12, 0x1e, 0x0a, 0x04, 0x63, 0x61, 0x72, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x0a, 0x2e, 0x63, 0x61, 0x72, 0x74, 0x2e, 0x43, 0x61, 0x72, 0x74, 0x52, 0x04, 0x63, 0x61, 0x72,
	0x74, 0x22, 0x59, 0x0a, 0x04, 0x43, 0x61, 0x72, 0x74, 0x12, 0x2b, 0x0a, 0x07, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x42, 0x12, 0xca, 0xf3, 0x18, 0x0e,
	...
	0x74, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x67, 0x0a, 0x0d,
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x37, 0x0a,
	...
	0x75, 0x73, 0x4d, 0x73, 0x67, 0x32, 0xce, 0x01, 0x0a, 0x0b, 0x43, 0x61, 0x72, 0x74, 0x48, 0x61,
	0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12, 0x3d, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x49, 0x74, 0x65, 0x6d,
	...
	0x6d, 0x52, 0x65, 0x73, 0x70, 0x22, 0x0d, 0xd2, 0xc1, 0x18, 0x09, 0x2f, 0x63, 0x61, 0x72, 0x74,
	0x2f, 0x61, 0x64, 0x64, 0x12, 0x39, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x43, 0x61, 0x72, 0x74, 0x12,
	...
	0x45, 0x0a, 0x09, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x43, 0x61, 0x72, 0x74, 0x12, 0x12, 0x2e, 0x63,
	0x61, 0x72, 0x74, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x71,
	0x1a, 0x13, 0x2e, 0x63, 0x61, 0x72, 0x74, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x43, 0x61, 0x72,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x0f, 0xe2, 0xc1, 0x18, 0x0b, 0x2f, 0x63, 0x61, 0x72, 0x74,
	0x2f, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_cart_proto_depIdxs = []int32{
	...
	1, // 3: cart.CartHandler.AddItem:input_type -> cart.AddItemReq
	4, // 4: cart.CartHandler.GetCart:input_type -> cart.GetCartReq
	3, // 5: cart.CartHandler.EmptyCart:input_type -> cart.EmptyCartReq
	2, // 6: cart.CartHandler.AddItem:output_type -> cart.AddItemResp
	5, // 7: cart.CartHandler.GetCart:output_type -> cart.GetCartResp
	7, // 8: cart.CartHandler.EmptyCart:output_type -> cart.EmptyCartResp
