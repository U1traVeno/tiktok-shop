...
type CreditCardInfo struct {
	...
	CreditCardNumber          string `protobuf:"bytes,1,opt,name=credit_card_number,json=creditCardNumber,proto3" form:"credit_card_number" json:"credit_card_number,omitempty" query:"credit_card_number"`
	CreditCardCvv             int32  `protobuf:"varint,2,opt,name=credit_card_cvv,json=creditCardCvv,proto3" form:"credit_card_cvv" json:"credit_card_cvv,omitempty" query:"credit_card_cvv"`
	CreditCardExpirationYear  int32  `protobuf:"varint,3,opt,name=credit_card_expiration_year,json=creditCardExpirationYear,proto3" form:"credit_card_expiration_year" json:"credit_card_expiration_year,omitempty" query:"credit_card_expiration_year"`
	CreditCardExpirationMonth int32  `protobuf:"varint,4,opt,name=credit_card_expiration_month,json=creditCardExpirationMonth,proto3" form:"credit_card_expiration_month" json:"credit_card_expiration_month,omitempty" query:"credit_card_expiration_month"`
}
...
type ChargeReq struct {
	...
	Amount     float32         `protobuf:"fixed32,1,opt,name=amount,proto3" form:"amount" json:"amount,omitempty" query:"amount"`
	CreditCard *CreditCardInfo `protobuf:"bytes,2,opt,name=credit_card,json=creditCard,proto3" form:"credit_card" json:"credit_card,omitempty" query:"credit_card"`
	OrderId    string          `protobuf:"bytes,3,opt,name=order_id,json=orderId,proto3" form:"order_id" json:"order_id,omitempty" query:"order_id"`
	UserId     uint32          `protobuf:"varint,4,opt,name=user_id,json=userId,proto3" form:"user_id" json:"user_id,omitempty" query:"user_id"`
}
...
type ChargeResp struct {
	...
	TransactionId string `protobuf:"bytes,1,opt,name=transaction_id,json=transactionId,proto3" form:"transaction_id" json:"transaction_id,omitempty" query:"transaction_id"`
}
...
var file_payment_proto_rawDesc = []byte{
	...
	0x55, 0x31, 0x74, 0x72, 0x61, 0x56, 0x65, 0x6e, 0x6f, 0x2f, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b,
	0x2d, 0x73, 0x68, 0x6f, 0x70, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f,
